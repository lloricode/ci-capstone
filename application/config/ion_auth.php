...
$config['default_group']              = 'faculty';           // Default group, use name
...
$config['lockout_time']               = 600;    /*10mins */            /* The number of seconds to lockout an account due to exceeded attempts
+							        You should not use a value below 60 (1 minute) */
$config['forgot_password_expiration'] = 60;        //1min           // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
$config['recheck_timer']              = 1800;        /* 1800 30mins           /* The number of seconds after which the session is checked again against database to see if the user still exists and is active.
 ...
 */
$config['remember_cookie_name'] = 'ci_capstone_remember_code';
$config['identity_cookie_name'] = 'ci_capstone_identity';
...
$asterisk=((ENVIRONMENT==='development')?'*':'');
$config['delimiters_source']       = 'config'; 	// "config" = use the settings defined here, "form_validation" = use the settings defined in CI's form validation library
$config['message_start_delimiter'] = '<div class="alert cifade alert-success alert-block">'.$asterisk; 	// Message start delimiter
$config['message_end_delimiter']   =$asterisk.'</div>'; 	// Message end delimiter
$config['error_start_delimiter'] = '<div class="alert cifade alert-error alert-block">'.$asterisk;  // Error message start delimiter
$config['error_end_delimiter'] = $asterisk.'</div>'; // Error message end delimiter
