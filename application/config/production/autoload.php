...
$autoload['libraries'] = array('ion_auth','migration','breadcrumbs','lib_log'/*this is only differ from DEVELOPMENT*/);
...
*/
$autoload['helper'] = array('date','url','html','language','navigation','permission','school','form');
...
*/
$autoload['model'] = array('Permission_model','Controller_model','Enrollment_status_model');
