...
$config['breadcrumb_el_open_extra'] = '';
$config['breadcrumb_el_close']      = '';

$config['breadcrumb_el_first']       = '<i class="icon-home"></i> ';
$config['breadcrumb_el_first_extra'] = array('title' => 'Got To Home', 'class' => 'tip-bottom');

$config['breadcrumb_el_last_open']       = '';
$config['breadcrumb_el_last_open_extra'] = array('class' => 'current');
